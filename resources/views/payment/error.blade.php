...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .icon { width:72px; height:72px; border-radius:50%; background:#fee2e2; display:flex; align-items:center; justify-content:center; margin:0 auto 1.5rem; }
        .icon i { font-size:2rem; color:#ef4444; }
...
<body>
    <div class="card">
        ...
        <p class="sub">Maaf, pembayaran tidak berhasil diproses. Silakan coba lagi atau hubungi kasir.</p>
        <a href="{{ route('pelanggan.riwayat') }}" class="btn"><i class="fa-solid fa-clock-rotate-left"></i> Coba Lagi</a>
    </div>
</body>
</html>

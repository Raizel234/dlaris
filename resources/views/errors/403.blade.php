...
<head>
    ...
    <title>403 — D'LARIS</title>
    <link rel="icon" type="image/svg+xml" href="{{ asset('favicon.svg') }}">
    <meta property="og:title" content="403 — D'LARIS">
    <meta property="og:description" content="D'LARIS Cafe & Karaoke — Akses Ditolak">
...
<body>
    ...
    <div class="card">
        ...
        <h1>403</h1>
        <h2>Akses Ditolak</h2>
        <p>Maaf, Anda tidak memiliki izin untuk mengakses halaman ini. Silakan hubungi admin jika ini seharusnya tersedia.</p>

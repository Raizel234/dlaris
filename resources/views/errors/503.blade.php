...
<head>
    ...
    <title>503 — D'LARIS</title>
    <link rel="icon" type="image/svg+xml" href="{{ asset('favicon.svg') }}">
    <meta property="og:title" content="503 — D'LARIS">
    <meta property="og:description" content="D'LARIS Cafe & Karaoke — Sedang Dalam Perbaikan">
...
<body>
    ...
    <div class="card">
        ...
        <p>Maaf, layanan sedang dalam perawatan. Silakan coba lagi dalam beberapa saat.</p>

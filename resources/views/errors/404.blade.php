...
<head>
    ...
    <title>404 — D'LARIS</title>
    <link rel="icon" type="image/svg+xml" href="{{ asset('favicon.svg') }}">
    <meta property="og:title" content="404 — D'LARIS">
    <meta property="og:description" content="D'LARIS Cafe & Karaoke — Halaman Tidak Ditemukan">
...
<body>
    ...
    <div class="card">
        ...
        <p>Maaf, halaman yang Anda cari tidak tersedia atau telah dipindahkan. Periksa kembali URL atau kembali ke beranda.</p>

...
<div class="mb-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-gray-600">Buat kategori menu baru</p>
        </div>
    </div>
</div>

<div class="bg-white rounded-xl shadow-sm max-w-lg">
    <form action="{{ route('admin.kategori.store') }}" method="POST" class="p-6 space-y-4" data-unsaved="true" oninput="this.dataset.dirty='true'" onsubmit="this.dataset.dirty='false'">
        @csrf
        <div>
        ...
        <div>
            ...
            <input type="text" name="ikon" value="{{ old('ikon') }}" placeholder="contoh: fa-solid fa-coffee" class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 border-gray-300">

...
<div class="mb-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Tambah Promo</h2>
            <p class="text-gray-600">Buat promo atau diskon baru</p>
        </div>
    </div>
</div>

<div class="bg-white rounded-xl shadow-sm max-w-2xl">
    <form action="{{ route('admin.promo.store') }}" method="POST" class="p-6 space-y-4" data-unsaved="true" oninput="this.dataset.dirty='true'" onsubmit="this.dataset.dirty='false'"
          x-data="promoForm()"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" x-model="form.kode" name="kode" value="{{ old('kode') }}" class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" :class="errors.kode ? 'border-red-500' : 'border-gray-300'" placeholder="CONTOH10" required>
            ...
            <div class="md:col-span-2">
                ...
                <textarea x-model="form.deskripsi" name="deskripsi" rows="3" class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 border-gray-300">{{ old('deskripsi') }}</textarea>
            ...
            <div x-show="form.tipe === 'persen' || form.tipe === 'nominal'" x-transition>
                ...
                <div class="relative">
                    <input type="number" x-model="form.nilai" name="nilai" value="{{ old('nilai') }}" step="0.01" class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" :class="errors.nilai ? 'border-red-500' : 'border-gray-300'">
            ...
            <div>
                ...
                <input type="number" x-model="form.min_belanja" name="min_belanja" value="{{ old('min_belanja') }}" class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 border-gray-300">
            ...
            <div x-show="form.tipe === 'persen'" x-transition>
                ...
                <input type="number" x-model="form.maks_diskon" name="maks_diskon" value="{{ old('maks_diskon') }}" class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 border-gray-300">
            ...
            <div>
                ...
                <input type="number" x-model="form.kuota" name="kuota" value="{{ old('kuota') }}" class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 border-gray-300">
            ...
            <div>
                ...
                <input type="datetime-local" x-model="form.berlaku_mulai" name="berlaku_mulai" value="{{ old('berlaku_mulai') }}" class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 border-gray-300">
            ...
            <div>
                ...
                <input type="datetime-local" x-model="form.berlaku_sampai" name="berlaku_sampai" value="{{ old('berlaku_sampai') }}" class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 border-gray-300">
...
document.addEventListener('alpine:init', () => {
    Alpine.data('promoForm', () => ({
        ...
        submitForm() {
            ...
            .then(d => {
                if (d.success) {
                    Swal.fire({ icon: 'success', title: 'Berhasil', text: d.message || 'Promo berhasil disimpan', timer: 1500, showConfirmButton: false });

...
<div class="mb-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-gray-600">Catat pengeluaran baru</p>
        </div>
    </div>
</div>

<div class="bg-white rounded-xl shadow-sm max-w-2xl">
    <form action="{{ route('admin.pengeluaran.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-4" data-unsaved="true" oninput="this.dataset.dirty='true'" onsubmit="this.dataset.dirty='false'"
          x-data="{
              form: { kategori: '', judul: '', deskripsi: '', jumlah: '', tanggal: '{{ date('Y-m-d') }}' },
              errors: {},
              previewUrl: null,
              validate() {
                  this.errors = {};
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" x-model="form.judul" name="judul" value="{{ old('judul') }}" class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" :class="errors.judul ? 'border-red-500' : 'border-gray-300'" required>
            ...
            <div>
                ...
                <input type="number" x-model="form.jumlah" name="jumlah" value="{{ old('jumlah') }}" step="0.01" class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" :class="errors.jumlah ? 'border-red-500' : 'border-gray-300'" required>

...
<div class="mb-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-gray-600">Buat ruangan karaoke baru</p>
        </div>
    </div>
</div>

<div class="bg-white rounded-xl shadow-sm max-w-2xl">
    <form action="{{ route('admin.ruangan.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-4" data-unsaved="true" oninput="this.dataset.dirty='true'" onsubmit="this.dataset.dirty='false'">
        @csrf
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="number" name="kapasitas" value="{{ old('kapasitas', 2) }}" min="1" class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 border-gray-300">
            ...
            <div>
                ...
                <input type="number" name="tarif_per_jam" value="{{ old('tarif_per_jam') }}" class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('tarif_per_jam') border-red-500 @enderror" required>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="fasilitas" rows="2" class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 border-gray-300" placeholder="Pisahkan dengan koma, contoh: AC, TV, Sofa">{{ old('fasilitas') }}</textarea>
